...
const Hero = () => {
  return (
    <>
      ...
      <h3>The Rules</h3>
      <p>
        To complete program, you <b>MUST</b> follow these 3 simple rules:
      </p>
      <ul className="rules-list">
        ...
        <div className="rule-item">
          ...
          <p>
            ...
            <abbr title="2 seconds - 2 seconds pause - 2 seconds up">
              2-2-2 tempo
            </abbr>
          </p>
        </div>
      ...
      <small>
        The first and second set should be at 75% and 85% of you working weight
        used for the last two reps
      </small>
